        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative z-10">
            {steps.map((step, index) => (
              ...
              >
                {/* Number Circle */}
                <div className="w-24 h-24 rounded-full bg-[#FCFBF7] border-2 border-[#ebebeb] flex items-center justify-center mb-8 relative transition-all duration-300 group-hover:border-[#3156ED] group-hover:shadow-[#3156ED]/10 group-hover:bg-[#FFFFFF] active:scale-95">
                  <span className="text-3xl font-serif text-[#00153A] group-hover:text-[#3156ED] transition-colors">
                    {step.number}
                  </span>
                </div>

                {/* Content */}
                <h4 className="body-text font-bold text-[#00153A] mb-2 group-hover:text-[#3156ED] transition-colors">
                  {step.title}
                </h4>
                <p className="text-[#00153A]/60 button-text max-w-[250px] mx-auto">
                  {step.description}
                </p>
              </div>
            ))}
