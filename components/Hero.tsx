        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-5xl lg:text-7xl font-extrabold text-[#001A3D] leading-[1.1] mb-6">
              Journey <span className="text-blue-600">Lightyears</span> Beyond
              Expectations.
            </h1>
            <p className="text-xl text-slate-600 mb-10 leading-relaxed max-w-lg">
              Elite education consultancy dedicated to guiding ambitious
              students toward the world's most prestigious institutions. Your
              potential is infinite; let's map the path.
            </p>
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <a
                href="#advisor"
                className="px-8 py-4 bg-[#001A3D] text-white rounded-xl font-bold text-lg hover:bg-blue-900 transition-all shadow-xl shadow-blue-900/10 flex items-center justify-center group"
              >
                Try AI Path Finder
                <svg
              ...
              <a
                href="#services"
                className="px-8 py-4 bg-white border border-slate-200 text-slate-800 rounded-xl font-bold text-lg hover:border-blue-300 hover:text-blue-600 transition-all flex items-center justify-center"
              >
                Explore Services
              </a>
            </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl shadow-xl z-20 max-w-xs border border-slate-100">
              ...
              <p className="text-xs text-slate-500">
                Every student we represent receives at least 3 offers from their
